...
void  ListeFilms::detruireFilm(Film* film)
{
	...
	if (indice_film != -1)
	{
		for (auto& acteurListe : span(elements[indice_film]->acteurs.elements, listeFilms.elements[indice_film]->acteurs.nElements))
		{
...
void  ListeFilms::afficherActeur(const Acteur& acteur)
{
	cout << "  " << acteur.nom << ", " << acteur.anneeNaissance << " " << acteur.sexe << endl;
}

//TODO: Une fonction pour afficher un film avec tous ces acteurs (en utilisant la fonction afficherActeur ci-dessus).
void  ListeFilms::afficherFilm(const Film& film)
{
